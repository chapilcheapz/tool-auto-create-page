    ...
    <div className="flex-1 w-full max-w-6xl mx-auto p-4 sm:p-6 flex flex-col gap-6 animate-in fade-in duration-300">
      ...
      <div className="bg-slate-900/50 backdrop-blur-md border border-zinc-800 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-2 justify-center sm:justify-start pb-2 border-b border-zinc-800/40 sm:pb-0 sm:border-none">
          ...
          <span className="text-xs font-semibold text-zinc-200 uppercase tracking-wider">Thống kê chiến dịch</span>
        </div>
      ...
      <div className="p-6 bg-slate-900/50 backdrop-blur-md border border-zinc-800 rounded-2xl shadow-xl flex flex-col gap-6">
        <div className="flex flex-col gap-1">
          <h2 className="text-xl font-bold text-white">Thả cảm xúc hàng loạt bằng Page</h2>
        ...
        <form onSubmit={handleStartCampaign} className="space-y-4">
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-zinc-400" htmlFor="inputPostUrl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold text-zinc-400" htmlFor="selectReaction">
                Chọn cảm xúc
              </label>
              <select
                id="selectReaction"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold text-zinc-400" htmlFor="inputReactCount">
      ...
      {showConsole && (
        <section className="flex flex-col gap-4 mt-2">
          <div className="flex items-center gap-2 px-1">
            ...
            <h3 className="text-sm font-bold text-white uppercase tracking-wider">Bảng điều khiển Tiến độ</h3>
          </div>

          <div className="p-4 bg-black/80 font-mono text-xs rounded-xl border border-zinc-800 min-h-[150px] max-h-[300px] overflow-y-auto space-y-1.5 shadow-inner">
            {logs.map((log, index) => {
